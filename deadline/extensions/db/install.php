...
function xmldb_deadline_extensions_install() {

    // Load all current extensions in mod_assign and convert them to the new extensions module.

    // Load all current overrides in mod_quiz and convert them to the new extensions module.
